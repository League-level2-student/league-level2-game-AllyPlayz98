...
public class gameLe extends Screen {
	Color textColor;
	JLabel label;
	JLabel insLabel;
	JLabel startLabel;
...
//		guessBox.setSize(5000, 20);
	...
	public void paintComponent(Graphics g) {
		...
		g.drawImage(bufferedImages[0], 350, 155, 100, 100, null);
		g.drawImage(bufferedImages[1], 450, 155, 100, 100, null);
